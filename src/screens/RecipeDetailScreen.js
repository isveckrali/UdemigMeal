            ...
            {/* meal description */}
            {
                loading ? (
                    ...
                    <View className="px-4 flex justify-between pt-8">
                                        ...
                                        return (
                                            <View key={i} className="flex-row space-x-4 mt-2  ">
                                                ...
                                                <View className="flex-row space-x-2">
                                                    <Text style={{ fontSize: hp(1.7) }} className="font-extrabold text-neutral-600">{meal['strIngredient' + i]}</Text>
                                                    <Text style={{ fontSize: hp(1.7) }} className="font-medium text-neutral-600">{meal['strMeasure' + i]}</Text>
                                                </View>
                        ...
                        {/* talimatlar */}
                        <Animated.View entering={FadeInDown.delay(100).duration(700).springify().damping(12)} className="mt-8">
                            <Text
                            ...
                            <Text
                                style={{ fontSize: hp(1.6), lineHeight: hp(2.5) }}
